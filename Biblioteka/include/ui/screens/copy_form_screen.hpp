...
class CopyFormScreen : public Screen {
public:
    explicit CopyFormScreen(controllers::CopiesController& controller);
...
private:
    ...
    [[nodiscard]] static copies::CopyStatus parse_status(const std::string& raw);
