...
class ReaderLoanHistoryScreen : public Screen {
public:
    explicit ReaderLoanHistoryScreen(controllers::ReadersController& controller);
...
private:
    ...
    std::vector<readers::ReaderLoanHistoryEntry> history_;
};
