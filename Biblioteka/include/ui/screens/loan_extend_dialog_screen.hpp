...
class LoanExtendDialogScreen : public Screen {
public:
    explicit LoanExtendDialogScreen(controllers::LoansController& controller);
...
private:
    ...
    std::string current_due_date_;
    std::string new_due_date_;
};
