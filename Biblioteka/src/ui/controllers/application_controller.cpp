...
ApplicationController::ApplicationController(Library& library, ScreenManager& screen_manager)
    : library_(library), screen_manager_(screen_manager), dashboard_controller_(library_) {}
...
void ApplicationController::bootstrap() {
    ...
    screen_manager_.register_screen(std::make_unique<screens::PlaceholderScreen>("books", "Ksiazki"));
